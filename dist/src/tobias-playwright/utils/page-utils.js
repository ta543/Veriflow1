...
function switchPage(winNum) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        while (page.context().pages().length < winNum && Date.now() - startTime < timeout_constants_1.SMALL_TIMEOUT) {
            yield new Promise(resolve => setTimeout(resolve, 100));
        }
        if (page.context().pages().length < winNum) {
            throw new Error(`Page number ${winNum} not found after ${timeout_constants_1.SMALL_TIMEOUT} seconds`);
        }
