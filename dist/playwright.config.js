...
const timeout_constants_1 = require("dist/src/tobias-playwright/utils/timeout-constants");
...
exports.default = (0, test_1.defineConfig)({
     ...
     */
    reporter: [['./src/tobias-playwright/setup/custom-logger.ts'], ['html', { open: 'never' }], ['dot']],
    /**
    ...
    timeout: timeout_constants_1.TEST_TIMEOUT,
    expect: {
        timeout: timeout_constants_1.EXPECT_TIMEOUT,
    },
    use: {
        headless: true,
